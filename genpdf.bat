...
wkhtmltopdf -d 300 --viewport-size 1024x768 --margin-left 0mm --margin-right 0mm --margin-top 0mm --margin-bottom 0mm http://localhost:4000/online-cv/ assets/pdf/steven_wells_resume.pdf 
